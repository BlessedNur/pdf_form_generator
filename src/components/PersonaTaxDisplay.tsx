  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      const sectionsToRender = [
        {
          title: "Form Header",
          condition: true, // Always render the header
          render: (input: HTMLElement) => {
            return input.querySelector("header") as HTMLElement;
          },
        },
        {
        ...
        <main className="p-4 flex flex-col gap-6">
          ...
          <section className="flex flex-col gap-2 mt-6">
            ...
            {(formData.dividendIncome || formData.interestIncome) && (
              <div className="mt-4">
                <h3 className="mb-2 font-semibold">
                  SECTION 2.3: Investment Income (For individuals earning
                  passive income){" "}
                </h3>
                ...
                {formData.interestIncome && (
                  <div>
                    <h4 className="mb-2 font-medium">
                      {" "}
                      B) Interest Income (Money earned from lending or saving
                      money)
                    </h4>
            ...
            {(formData.rentalIncome || formData.secondRentalIncome) && (
              <div className="mt-4">
                <h3 className="mb-2 font-semibold">
                  C) Rental Income (Money earned from renting out property){" "}
                </h3>
